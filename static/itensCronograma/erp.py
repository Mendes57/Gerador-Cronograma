...
def erp():
    return [["*ERP:*"],
            [f"Solicitação do IP Fixo, favor verificarcom operadora de internet - *{dadosCliente[0]}* - ",
            f"Verificar emissão de Notas (Não emitir, Somente vendas com CPF, Emitir todas) - *{dadosCliente[0]}* - ",
