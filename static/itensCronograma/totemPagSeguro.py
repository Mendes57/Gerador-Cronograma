...
def totemPagSeguro():
    return [["*PagSeguro e Servidor:*"],
            ...
            f"Adquirir leitor de Código de Barras (Link abaixo do cronograma) - *{dadosCliente[0]}* -",
            f"Envio de código de ativação e envio de foto da parte de trás da Smart PagSeguro - ACCESYS e *{dadosCliente[0]}* -",
            f"Vínculo de Nr Série da Smart - ACCESYS -"
            f'Instalar app no totem, favor abrir loja de apps e pesquisar por "lojas express" e instalar o app - *{dadosCliente[0]}* -'
            f'Realizar teste de vendas, crédito, débito e PIX - *{dadosCliente[0]}* -']
            ]